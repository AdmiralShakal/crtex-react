...
function Testimonials() {
  ...
  const handleLeftClick = () => {
    setOffset(() => {
      if (offset === 0) return -(PAGE_WIDTH * (pages.length - 1));
      const newOffset = offset + PAGE_WIDTH;
      return newOffset;
    });
  };
  ...
  useEffect(() => {
    setPages(
      Children.map(TestimonialsItems().props.children, (child) => {
        console.log();
  ...
  return (
    <section className="testimonials testimonials__main">
      <div className="container">
        <div className="testimonials__inner">
          <div className="testimonials__heading heading--text-center">
            <p className="heading__subtitle">Testimonials</p>
            <h2 className="heading__title">What our students say</h2>
          </div>
          ...
          <div className="testimonials__slider-wrapper">
            ...
            <div
              className="testimonials__arrow testimonials__prev"
            ...
            <div
              className="testimonials__arrow testimonials__next"
